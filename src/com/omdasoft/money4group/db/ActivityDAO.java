...
public class ActivityDAO {
	...
	public static ActivityDAO getInstance(Context c) {
		if (instance == null) {
			instance = new ActivityDAO(c);
		}
		return instance;
	}
	...
	public long insert(ActivityModel am) {

		try{
			ContentValues newActValue = new ContentValues();
			newActValue.put(Money4GroupDBOpenHelper.ACT_NAME, am.getActName());
			newActValue.put(Money4GroupDBOpenHelper.ACT_TYPE, am.getActType());
			newActValue.put(Money4GroupDBOpenHelper.START_AT, am.getStartAt());
			newActValue.put(Money4GroupDBOpenHelper.END_AT, am.getEndAt());
	...
	public long update(ActivityModel am) {
	...
	public boolean updateOrInsert(ActivityModel rm) {
		long res = update(rm);
		if(res > 0){
			return true;
		}else{
